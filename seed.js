...
const seed = async () => {
    ...
    const dog1 = await Dog.create({
        name: "Charlie",
        age: 1,
        picture: 'https://i.insider.com/5df126b679d7570ad2044f3e?width=1100&format=jpeg&auto=webp'
    })

    const dog2 = await Dog.create({
        name: "Cooper",
        age: 2,
        picture: 'https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/golden-retriever-dog-royalty-free-image-505534037-1560893368.jpg?crop=0.509xw:1.00xh;0.314xw,0&resize=768:*'
    })
